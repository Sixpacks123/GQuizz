<template>
    <div>
        ...
        <div class="flex flex-col">
            ...
            <div class="flex flex-col justify-center items-center">
                <img src="/img/logos/bonus.png" class = "w-10 h-10 mr-4">
                <p>If a player knows the name of the artist, the piece of art, or both, they can say it and will chose one opponent to move backward 1 tile. If mutiple players have one of these answers, this power goes to the first one to say it. 
The player removes the card and the player on his left chooses the next card. </p>
